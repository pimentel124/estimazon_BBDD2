  ...
  ⇂ create table `users` (`id` bigint unsigned not null auto_increment primary key, `full_name` varchar(255) null, `password` varchar(255) not null, `NIF` varchar(255) null, `email` varchar(255) not null, `role_id` int not null default '1', `address` bigint null, `remember_token` varchar(100) null, `created_at` timestamp null, `updated_at` timestamp null) default character set utf8mb4 collate 'utf8mb4_unicode_ci'  
